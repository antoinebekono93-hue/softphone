  ...
  return (
    <section className="py-32 px-4 max-w-7xl mx-auto w-full text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mb-10">
        ...
        <Link href="/pricing" className="inline-flex text-lg font-semibold text-[var(--text-primary)] bg-slate-900 border border-white/10 hover:bg-slate-800 px-10 py-5 rounded-full transition-all items-center gap-2">
          Voir les tarifs
        </Link>
