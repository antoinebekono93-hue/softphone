...
assert.equal(resolveDashboardModule('/dashboard/sms-inbox'), 'social');
...
assert.equal(resolveDashboardModule('/dashboard/softphone'), 'phone');

// Shared pages retain the module chosen in the navigation.
assert.equal(resolveDashboardModule('/dashboard/numbers', 'voice'), 'voice');
assert.equal(resolveDashboardModule('/dashboard/settings', 'social'), 'social');
assert.equal(resolveDashboardModule('/dashboard/numbers', 'invalid'), 'phone');
assert.equal(resolveDashboardModule('/dashboard/tickets', 'phone'), 'ai');
